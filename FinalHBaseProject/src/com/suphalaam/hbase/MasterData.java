...
public class MasterData {
	...
	public static List<ResultRow> fetchResult(String book,String course,String download,
		...
		checkGroup+" "+checkSub);
		/*ResultRow rr1 = new ResultRow("cookie1");
		ResultRow rr2 = new ResultRow("cookie2");
		ResultRow rr3 = new ResultRow("cookie3");
		ResultRow rr4 = new ResultRow("cookie4");*/
...
//		lst.add(rr4);
	...
	public static void main(String [] arg) throws IOException, Exception{
		...
		System.out.println(MasterData.fetchResult("a","b","c","d","e","1","1","1"));
