 ...
 */
public class RecommendationtService {
	
	private static final transient Logger log = Logger.getLogger(RecommendationtService.class);
	
	public static void main(String [] args) throws Exception{
		
		LinkedHashMap<String,VisitorBean> map =RecommendationtService.buildData();
	 ...
	 /*
	  * First set of queries to get the data for last 7 days
	  * 
	 */
	  private static GaData getRecommendationBook(Analytics analytics, String profileId) throws IOException {
		  
		  //get all the new visitor but system is able to identify them with visitor track
		  return analytics.data().ga()
	        .get("ga:" + profileId, "today", "7daysAgo", "ga:uniquePageviews,ga:sessions,ga:avgTimeOnPage,ga:bounceRate,ga:entrances,ga:exits,ga:pageValue")
	        .setDimensions("ga:pagePath")
	        .setFilters("ga:pagePath=@/details")
	        .setSort("-ga:uniquePageviews")
	        .setMaxResults(5000)
	        .execute();
	  }//end-of-method
