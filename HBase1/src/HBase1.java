...
public class HBase1 {
	...
	//static int String s1=new String();
	//static 
...
mylist.add(s);
     ...
     else{iterator2=0;String e = "" + "e_a[iterator2]";
    	 p.add(Bytes.toBytes("exam_name"),
       	      Bytes.toBytes(e),Bytes.toBytes(ex));
    	 int p1=0;
    	 for(int i=0;i<mylist.size();i++){
    		 if(mylist.get(i).equals(ex)==true)
    			 p1=1;}
    	 if(p1==0){p.add(Bytes.toBytes("subject"),
          	      Bytes.toBytes(s),Bytes.toBytes(sub));
